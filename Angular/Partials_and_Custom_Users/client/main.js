...
myApp.factory('userFactory', function() {
    var people = [
        {first_name: 'Basila', last_name: 'Nathan', fav_lang: 'Ruby'},
        {first_name: 'Saloni', last_name: 'Madan', fav_lang: 'JavaScript'},
        {first_name: 'Manish', last_name: 'Badwal', fav_lang: 'JavaScript'},
        {first_name: 'Tanjeev', last_name: 'Thandi', fav_lang: 'Python'}
    ];
    var factory = {};
